...
class TestUser(unittest.TestCase):
    ...
    def test_count(self):
        ...
        self.assertEqual(f.getvalue(), '*** Unknown syntax: count\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("count id")
        self.assertEqual(f.getvalue(), '*** Unknown syntax: count id\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("count BaseModel id")
        self.assertEqual(
            f.getvalue(), '*** Unknown syntax: count BaseModel id\n')
    ...
    def test_show(self):
        ...
        self.assertEqual(f.getvalue(), '*** Unknown syntax: User.show(1)\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("sdasdasd.show(1)")
        self.assertEqual(
            f.getvalue(), '*** Unknown syntax: sdasdasd.show(1)\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("User.show()")
        self.assertEqual(f.getvalue(), '*** Unknown syntax: User.show()\n')
    ...
    def test_destroy(self):
        ...
        self.assertEqual(f.getvalue(), '*** Unknown syntax: User.destroy(1)\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("sdasdasd.destroy(1)")
        self.assertEqual(
            f.getvalue(), '*** Unknown syntax: sdasdasd.destroy(1)\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("User.destroy()")
        self.assertEqual(f.getvalue(), '*** Unknown syntax: User.destroy()\n')
    ...
    def test_update(self):
        ...
        self.assertEqual(f.getvalue(), '*** Unknown syntax: asdasd.update()\n')
        with patch('sys.stdout', new=StringIO()) as f:
            HBNBCommand().onecmd("User.update()".format(id))
        self.assertEqual(f.getvalue(), '*** Unknown syntax: User.update()\n')
        with patch('sys.stdout', new=StringIO()) as f:
